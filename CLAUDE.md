...
- **Supabase** — Postgres + RLS + **private** storage bucket `pothole-photos` (every read mints a short-lived signed URL; see the photo rules below)
