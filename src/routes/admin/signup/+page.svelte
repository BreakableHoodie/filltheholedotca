		...
		{#if form?.registered}
			...
			<div class="bg-zinc-900 border border-zinc-800 rounded-xl p-8 text-center">
				...
				<p class="text-zinc-400 text-sm leading-relaxed">
					Your account has been created with the <strong class="text-zinc-300"
						>{data.invite?.role ?? 'editor'}</strong
					> role. An administrator will activate it before you can log in.
				</p>
				<a
					href="/admin/login"
