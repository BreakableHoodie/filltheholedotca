			...
			<nav class="flex-1 px-2 py-3 space-y-0.5">
				...
				<div class="pt-2 mt-1 border-t border-zinc-800">
					<a
						...
						class="flex items-center gap-2.5 px-3 py-2 rounded text-sm transition-colors {isActive('/admin/settings') ? 'bg-sky-600/20 text-sky-400' : 'text-zinc-400 hover:text-zinc-100 hover:bg-zinc-800'}"
					>
						<svg class="w-4 h-4 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
