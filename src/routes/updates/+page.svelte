...
<div class="max-w-2xl mx-auto px-4 py-12 space-y-10">
	<div>
		...
		<p class="page-intro text-stone-600 dark:text-stone-400 text-lg">
			Improvements we've shipped to the tracker. This is a community project, built in the
			open.
		</p>
	</div>
				...
				<ul class="space-y-2">
					{#each entry.items as item (item)}
						<li class="flex gap-2.5 text-stone-600 dark:text-stone-400 leading-relaxed">
							<span
								class="mt-2 w-1.5 h-1.5 rounded-full bg-amber-500 shrink-0"
								aria-hidden="true"
							></span>
							<span>{item}</span>
						</li>
	...
	<p class="text-sm text-stone-500 dark:text-stone-400">
		...
		<a
			...
			class="underline hover:text-stone-700 dark:hover:text-stone-200 transition-colors"
			>GitHub</a
		>.
	</p>
</div>
