...
import { COUNCILLORS, type Councillor } from '$lib/wards';
...
const E2E_DETAIL_FIXTURES: Record<string, E2eDetailFixture> = {
	'11111111-1111-4111-8111-111111111111': {
		...
		cityRepairRequests: [{ intersection: 'King St W & Union St W', date: '2026-03-06' }],
		photos: [],
	...
	'22222222-2222-4222-8222-222222222222': {
		...
		councillor: COUNCILLORS.find((c) => c.city === 'waterloo' && c.ward === 6) ?? null,
		cityRepairRequests: [],
		photos: [],
		confirmationThreshold: 2,
		hitCount: 0,
