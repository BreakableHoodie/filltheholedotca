	...
	<section class="space-y-4 text-stone-600 dark:text-stone-400 leading-relaxed">
		...
		<div class="bg-white dark:bg-stone-900 border border-stone-200 dark:border-stone-800 rounded-md p-4">
			<ul class="space-y-1.5 text-sm">
				...
				<li><a href="https://www.esri.com/en-us/privacy/main" target="_blank" rel="noopener noreferrer" class="text-amber-700 dark:text-amber-400 underline">Esri ArcGIS</a> — on pothole pages we check the City of Kitchener's Corporate Contact Centre (its service-request system) for a matching repair request. Our server sends only the pothole's rounded coordinates.</li>
